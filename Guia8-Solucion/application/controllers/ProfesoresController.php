...
class ProfesoresController extends CI_Controller
{
    ...
    public function report_todos_los_profesores()
    {
        ...
        $this->table->set_heading('Id Profesor', 'Nombre', 'Apellido', 'Fecha de Nacimiento', 'Profesion', 'Genero', 'Email');
        ...
        foreach ($profesores as $profesor):
            $this->table->add_row($profesor->idprofesor, $profesor->nombre, $profesor->apellido, $profesor->fecha_nacimiento, $profesor->profesion, $profesor->genero, $profesor->email);
        endforeach;
